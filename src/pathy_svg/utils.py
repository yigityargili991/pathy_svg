"""SVG manipulation utilities and backward-compatible re-exports.

The color and data functions have been moved to ``pathy_svg.color`` and
``pathy_svg.data`` respectively. They are re-exported here for backward
compatibility.
"""
