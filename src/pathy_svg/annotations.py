    ...
    *,
    ...
    if method == "title":
        ...
        style.text = (
            ...
            "[data-tooltip]:focus + .pathy-tooltip, "
            "[data-tooltip]:focus-visible + .pathy-tooltip { display: inline; }\n"
            "[data-tooltip]:focus-visible { outline: 2px solid #005fcc; outline-offset: 2px; }"
        )
